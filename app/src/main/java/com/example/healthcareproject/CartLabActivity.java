...
public class CartLabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateButton = findViewById(R.id.CartDeliverDatePicker);
        timeButton = findViewById(R.id.CartDeliverTimePicker);
        CheckoutButton = findViewById(R.id.Cart_btnCheckOut);
        BackButton = findViewById(R.id.LTBook_Backbtn);
        tvTotal = findViewById(R.id.TotalCost);
        lst = findViewById(R.id.Cart_ListView);
